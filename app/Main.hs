...
main = do
            ...
            print $ descendSteps csvData computeGradRowLogistic [(0.0::Double),(0.0::Double),(1.1::Double)] (10000::Int) (0.001::Double)
            print $ hTheta [1,2,3] [0,1,2]
            print $ computeGradRowLogistic [1,2,3] [0,1,2]
...
computeGradRowLogistic params dataList =  [(hTheta params dataList) - (head dataList)] ++ (tail (zipWith (*) dataList (map (subtract (head dataList)) (take (length dataList) (cycle [hTheta params dataList])))))
